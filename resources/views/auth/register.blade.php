                    ...
                    <div class="col-lg-5">
                        <div class="location-form">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="control-group">
                                    <input id="custPhone" type="text" class="form-control @error('custPhone') is-invalid @enderror"  placeholder="Phone Number" name="custPhone" value="{{ old('custPhone') }}" required autocomplete="custPhone"/>
                                    @error('custPhone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="control-group">
                                    <textarea class="form-control" id="custAddress" placeholder="Address" class="form-control @error('custAddress') is-invalid @enderror" name="custAddress" value="{{ old('custAddress') }}" required autocomplete="custAddress"></textarea>
                                    @error('custAddress')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="control-group">
                                    <input id=id="password-confirm" type="password" placeholder="Confirm Password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                                </div>


                                <div>
                                    <button class="btn btn-custom" type="submit">{{ __('Register') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
