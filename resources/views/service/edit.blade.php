                                        ...
                                        <div class="row">										
											<div class="col-md-12">
												<div class="form-group">
                                                    ...
                                                    <input type="text" name="serviceName" value="{{ $service->serviceName }}" class="form-control" placeholder="Service Name">
												</div>
											</div>
                                            ...
                                            <div class="col-md-12">
												<div class="form-group">
												 ...
												 <input type="text" class="form-control" name="price" value="{{ $service->price }}" placeholder="Price"></input>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
                                                    ...
                                                    <input type="textArea" class="form-control" name="description" value="{{ $service->description }}" placeholder="Description"></input>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
