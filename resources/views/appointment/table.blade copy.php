...
<head>
    ...
    <!-- FullCalendar -->
    <link href=' {{ asset('customer-template/vendor/fullcalendar-3.10.0/fullcalendar.css') }}" rel='stylesheet' media="all" />
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src=" {{ asset('customer-template/images/icon/logo.png') }}" alt="CoolAdmin" />
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{ asset('customer-template/') }}"images/icon/logo.png" alt="Cool Admin" />
                </a>
            </div>
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('customer-template/') }}"images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('customer-template/') }}"images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('customer-template/') }}"images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('customer-template/') }}"images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('customer-template/') }}"images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
    ...
    <script src="{{ asset('customer-template/vendor/select2/select2.min.js') }}"></script>

    <!-- full calendar requires moment along jquery which is included above -->
    <script src="{{ asset('customer-template/vendor/fullcalendar-3.10.0/lib/moment.min.js') }}"></script>
    <script src="{{ asset('customer-template/vendor/fullcalendar-3.10.0/fullcalendar.js') }}"></script>
